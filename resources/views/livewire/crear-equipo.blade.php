<form action="" class="md:w-1/2 space-y-5" wire:submit.prevent='crearEquipo'>
    ...
    <div>
        ...
        <x-text-input id="categoria" class="block mt-1 w-full" type="text" wire:model="categoria" 
            :value="old('categoria')" placeholder="Categoría del equipo" />
    ...
    <div>
        ...
        <x-text-input id="ubicacion" class="block mt-1 w-full" type="text" wire:model="ubicacion" 
            :value="old('ubicacion')" placeholder="Ubicación física del equipo" />
    ...
    <div>
        ...
        <select id="estado" wire:model="estado" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full">
